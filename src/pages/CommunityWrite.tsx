      ...
      <Card>
        <CardContent className="p-6 space-y-6">
          <div className="flex justify-between items-center border-b border-border-color pb-4">
             <h1 className="text-xl font-bold flex items-center gap-2"><Edit2 className="w-5 h-5 text-brand" /> 게시글 작성</h1>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="border border-border-color rounded-[16px] overflow-hidden flex flex-col focus-within:ring-2 focus-within:ring-brand transition-all">
               <div className="bg-bg-main border-b border-border-color p-2 flex gap-2">
                 <button className="px-3 py-1 rounded-[8px] hover:bg-border-color text-sm font-semibold transition-colors">B</button>
                 <button className="px-3 py-1 rounded-[8px] hover:bg-border-color text-sm font-semibold italic transition-colors">I</button>
                 <button className="px-3 py-1 rounded-[8px] hover:bg-border-color text-sm font-semibold underline transition-colors">U</button>
               </div>
               <textarea 
          ...
          <div className="flex justify-end gap-3 pt-4">
             <Link to="/community">
                <Button variant="secondary" className="px-8">취소</Button>
             </Link>
             <Link to="/community">
                <Button className="px-8">등록</Button>
             </Link>
          </div>
        </CardContent>
      </Card>
