      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <Card className="flex flex-col h-[600px] border-border-color">
            ...
            <div className="p-3 border-t border-border-color bg-surface shrink-0 rounded-b-[16px] space-y-2">
              {disconnectReason ? (
                  ...
                  {pendingImageUrl && (
                    <div className="relative inline-block">
                      ...
                      <button
                        ...
                        className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-black/60 text-white flex items-center justify-center cursor-pointer"
                      >
                        <X className="w-3 h-3" />
                      </button>
                    </div>
